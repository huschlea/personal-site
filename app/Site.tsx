    ...
    <div className="site site-v2">
        ...
        <section className="v2-panel v2-panel-design">
          <div className="v2-section">
            ...
            <p className="v2-section-body">
              WethosAI is an executive decision intelligence company incubated inside NumberOne AI. I lead brand, website, and marketing design. An AI-forward identity built from scratch so the surface area of the work can move as fast as the product.
            </p>
      ...
      {tab === "observations" && (
        <section className="v2-panel v2-panel-observations">
          {[
            { title: "Trust as immersion", body: "Trust often precedes comprehension. Care shown in one place is felt as a promise of care everywhere. The purest output of any interaction is the quiet relief of immersion that's born out of earned trust. This holds true across people, surfaces, and mediums." },
