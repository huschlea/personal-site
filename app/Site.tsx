    ...
    <div className="site site-v2">
      ...
      {tab === "observations" && (
        <section className="v2-panel v2-panel-observations">
          {[
            { title: "Trust as immersion", body: "Trust often precedes comprehension. Care shown in one place is felt as a promise of care everywhere. The purest output of any interaction is the quiet relief of immersion that's born from earned trust. This holds true across people, surfaces, and mediums." },
