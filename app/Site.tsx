    ...
    <div className="site site-v2">
      ...
      {tab === "observations" && (
        <section className="v2-panel v2-panel-observations">
          {[
            { title: "Design for relief", body: "Trust often precedes comprehension. Care shown in one place is felt as a promise of care everywhere. The purest output design can offer is not beauty or clarity but the quiet relief of immersion that comes with trusting the perspective of a stranger." },
