...
// Single source for the essays: rendered here, and compiled into the
// design-system chat corpus by scripts/build-design-system-corpus.mjs.
        ...
        <section className="v2-panel v2-panel-design">
          <div className="v2-section">
            ...
            <p className="v2-section-body">
              A living design system that codifies what a brand knows, how it speaks, the machinery it employs, and the laws that keep it uniform and distinct.
            </p>
            <p className="v2-section-body v2-release-links">
              <a href="/design-os" className="v2-link">Explore the system <UpRightArrow /></a>
            </p>
          </div>
          ...
          <div className="v2-section">
            ...
            <p className="v2-section-body">
              WethosAI is an executive decision intelligence company incubated inside NumberOne AI. I lead brand and web design with an AI-forward identity built from scratch so the surface area of the work can move as fast as the product.
            </p>
            <p className="v2-section-body v2-release-links">
